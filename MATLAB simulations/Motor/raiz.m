...
print(figure(1),'experimento','-dpng','-r300');  % experimento
print(get_param('bloques_motor','Handle'), '-dpng', '-r300', 'diagrama');  % diagrama de bloques
print(get_param('bloques_motor/C(z)1', 'Handle'), '-dpng', '-r300', 'controlador');  % diagrama del controlador
